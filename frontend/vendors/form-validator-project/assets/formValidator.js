  ...
  FormValidator = (function(form, validations, options) {
    ...
    var
      validator = {
        ...
        _messages: {},
        _errors: {},
        errorElement: options && options.errorElement || 'label',
        ...
        defaultMessages: {
          ...
          equalTo: options && options.equalTo || 'This field is wrong.',
          number: options && options.defaultMessages.number || 'Fill just with numbers'
        },
        _validations: {
          ...
          number: function(value, element, param) {
            return validator.optional(element) || isNaN(value) === false;
          }
        },
        /**
        ...
        getFields: function() {
          if (validator._fields.length === 0) {
            var
              _fields = Object.keys(validations.rules),
              fields  = [],
              inputs  = [];
            ...
            fields = validator._form.querySelectorAll(inputs.join(', '));
        ...
        addErrorMessage: function(field, message, param) {
          ...
          if (!component) {
            var
              errorComponent = document.createElement(validator.errorElement);
            ...
            field.className = field.className.replace(' ' + validator.messageErrorClass);
            field.className = field.className + ' ' + validator.messageErrorClass;
        ...
        removeErrorMessage: function(field) {
          var
            component = field.parentElement.querySelector(validator.errorElement + '.' + validator.messageErrorClass);
          ...
          if (fieldName in validations.rules) {
            ...
            for (var rule in rules) {
              if (rules.hasOwnProperty(rule)) {
                ...
                if (typeof validator._validations[method] === 'function') {
        ...
        handleRemoveErrorOnBlur: function() {
          var
            elements = validator._form.querySelectorAll('.' + validator.containerFieldErrorClass),
            element,
            field;
        ...
        init: function() {
          ...
          validator._form = typeof form === 'string' ? document.querySelector(form) : form;
          ...
          //Brake the submit
          validator._form.addEventListener('submit', validator.handleOnSubmit);
        }
      };
